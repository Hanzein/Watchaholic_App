...
import com.watch.usershop.databinding.ActivityProfileBinding;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT,"farhanadinugraha17@gmail.com");
    ...
    void processAbout(){
        new AlertDialog.Builder(this)
                .setTitle("About Us")
                .setCancelable(false)
                .setMessage("This is Watchaholic users E-Shopping App.\nVersion 1.0.0\nHappy Shopping!!!")
