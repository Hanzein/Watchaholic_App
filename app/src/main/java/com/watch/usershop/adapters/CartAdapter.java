package com.watch.usershop.adapters;
...
import com.watch.usershop.databinding.ItemCartBinding;
import com.watch.usershop.databinding.ItemCategoriesBinding;
import com.watch.usershop.databinding.QuantityDialogBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.binding.price.setText(CurrencyConvert.currencyConverter("ID","id",product.getPrice()));
        //holder.binding.price.setText("Rp "+ product.getPrice());
            ...
            public void onClick(View view) {
                ...
                quantityDialogBinding.plusBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        cart.updateItem((Item) product, product.getQuantity());
